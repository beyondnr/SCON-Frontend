      ...
      <main className="flex-1 flex flex-col items-center justify-center text-center p-4">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-4xl md:text-6xl font-headline font-bold tracking-tight text-foreground mb-4">
            사장님, 이제 근무표 관리는<br />
            <span className="text-primary">SCON</span>에 맡기세요
          </h1>
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-8">
            복잡한 수당 계산, 까다로운 근로기준법 준수, 번거로운 근무표 조정까지.<br />
            SCON이 사장님의 매장 관리를 스마트하게 자동화합니다.
          </p>
        ...
        <div className="mt-20 w-full max-w-5xl">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <FeatureCard 
                    ...
                    title="자동화된 근무표 생성"
                    description="직원 가용 시간을 기반으로 최적의 근무표를 자동 생성하고, 법규 위반을 사전에 경고합니다."
                />
                <FeatureCard 
                ...
                <FeatureCard 
                    icon={<Zap className="w-8 h-8 text-primary" />}
                    title="간편한 관리"
                    description="온보딩부터 직원 관리, 근무표 승인까지 모든 과정을 몇 번의 클릭으로 해결할 수 있습니다."
                />
            </div>
        </div>
      </main>
